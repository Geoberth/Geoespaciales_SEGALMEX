...
public class PGOperativoGranos_bd {

    public static final String TABLA_BD = "TB_PG_OPERATIVO_GRANOS";
    ...
    public static final String COLUMN_CUATROA = "CUATROA";
    public static final String COLUMN_CUATROB = "CUATROB";
    public static final String COLUMN_CUATROC = "CUATROC";
    public static final String COLUMN_CUATROD = "CUATROD";
    public static final String COLUMN_CINCOA = "CINCOA";
    public static final String COLUMN_CINCOB = "CINCOB";
    public static final String COLUMN_CINCOC = "CINCOC";
    public static final String COLUMN_CINCOD = "CINCOD";
    public static final String COLUMN_CINCOE = "CINCOE";
    public static final String COLUMN_CINCOF = "CINCOF";
    ...
    public static final String COLUMN_DIEZOBS = "DIEZOBS";
    ...
    public static final String CREAR_TABLA_PG_OPERATIVO_GRANOS= "CREATE TABLE " + TABLA_BD + "("
            ...
            + COLUMN_CUATROA + " VARCHAR, "
            + COLUMN_CUATROB + " VARCHAR, "
            + COLUMN_CUATROC + " VARCHAR, "
            + COLUMN_CUATROD + " VARCHAR, "
            + COLUMN_CINCOA + " VARCHAR, "
            + COLUMN_CINCOB + " VARCHAR, "
            + COLUMN_CINCOC + " VARCHAR, "
            + COLUMN_CINCOD + " VARCHAR, "
            + COLUMN_CINCOE + " VARCHAR, "
            + COLUMN_CINCOF + " VARCHAR, "
